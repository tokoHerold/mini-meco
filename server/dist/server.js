...
(0, database_1.initializeDb)().then((db) => {
    ...
    app.get('/getUserStatus', (req, res) => { (0, projMgmt_1.getUserStatus)(req, res, db); });
    ...
    app.post('/updateAllConfirmedUsers', (req, res) => (0, projMgmt_1.updateAllConfirmedUsers)(req, res, db));
    app.listen(port, () => {
